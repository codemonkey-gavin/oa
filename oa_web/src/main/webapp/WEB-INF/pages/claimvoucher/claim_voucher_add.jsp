    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form id="admin-form" name="addForm" action="/claim_voucher/add" modelAttribute="info" method="post">
                            ...
                            <div>
                                <div class="col-md-3">
                                    <label for="items[0].item" class="field prepend-icon">
                                        <form:select path="items[0].item" items="${items}" class="gui-input" placeholder="花销类型..."/>
                                    </label>
                                </div>
                                <div class="col-md-3">
                                    <label for="items[0].amount" class="field prepend-icon">
                                        <form:input path="items[0].amount" class="gui-input money" placeholder="金额..."/>
                                ...
                                <div class="col-md-5">
                                    <label for="items[0].comment" class="field prepend-icon">
                                        <form:input path="items[0].comment" class="gui-input" placeholder="备注..."/>
